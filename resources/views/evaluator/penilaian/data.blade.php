        ...
        <script>
            ...
            var columns = [
                    ...
                    @if ($jabatan == 'Staff')
                {
                    ...
                    "render": function (data, type, row) {
                        if (row.status === 'submit' || row.status === 'sementara') {
                            return '<a href="{{ url($route) }}/evaluasi/' + row.id + '" class="btn btn-sm btn-warning" id="edit_' + row.id + '" onclick=""><i class="fa fa-edit"></i> Evaluasi</a>';
                        }
                    }
                }
                @endif
