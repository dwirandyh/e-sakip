            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                @component('components.select', ['title' => 'Satuan Kerja', 'name' => 'id_satuan_kerja', 'options' => $satuanKerja, 'isRequried' => true])
                                @endcomponent
                            </div>
                            <div class="col-sm-6">
                                @component('components.text_input', ['title' => 'Nama Petugas', 'type' => 'text', 'name' => 'nama', 'placeholder' => 'Nama Petugas', 'isRequried' => true])
                                @endcomponent
                            </div>
                            <div class="col-sm-6">
                                @component('components.select', ['title' => 'Jabatan', 'name' => 'jabatan', 'options' => \Config::get('custom.jabatanSatker'), 'selected' => old('jabatan'), 'isRequried' => true])
                                @endcomponent
                            </div>
                            <div class="col-sm-6">
                                @component('components.text_input', ['title' => 'email', 'type' => 'email', 'name' => 'email', 'placeholder' => 'Email', 'isRequried' => true])
                                @endcomponent
                            </div>
                            <div class="col-sm-6">
                                @component('components.text_input', ['title' => 'Password', 'type' => 'password', 'name' => 'password', 'placeholder' => 'Password', 'isRequried' => true])
                                @endcomponent
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                @component('components.select', [
                                    ...
                                    'options' => \Config::get('custom.jabatanSatker'),
