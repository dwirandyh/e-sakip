...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Revisi Penilaian LKE
            </h1>
            <ol class="breadcrumb">
                <li><a href="{{ url('/') }}"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="{{ url('/penilaian') }}">Penilaian</a></li>
                <li class="active">Revisi Penilaian LKE</li>
            </ol>
        </section>

        <form role="form" method="post" action="{{ url('/penilaian/revisi/' . $penilaian->id . '/submit') }}" enctype="multipart/form-data">
        @csrf
        <!-- Main content -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Form Revisi Penilaian LKE</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
